...
//        }
        ...
        // Check if the type is image and deletes its thumbnail.
        if($type == 'Images'){
          $thumbnailsConfig = $_config->getThumbnailsConfig();
          $dir = substr($thumbnailsConfig->getDirectory()."Images/" . $name, 1);
          $s3->deleteObject($config['AmazonS3']['Bucket'], $thumbnailPath);
        }
