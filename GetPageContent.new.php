...
elseif ($CHECK_PAGE) {
	...
	case 11:
		 ...
		 break;
	case 12:
		 include_once("short_content_bottom_theme.php");
		 break;
	case 14:
	...
	case 2:
		...
		//$debug=true;
		if (($mobileDetect->isMobile() OR $debug OR $SITE[mobile_preview]==1) AND ($SITE[mobileEnabled])) include_once("effect_gallery.mobile.php");
