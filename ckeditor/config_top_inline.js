...
CKEDITOR.editorConfig = function( config )
{
	...
	config.extraPlugins='autogrow,oembed,imagemaps,mobview,doksoft_font_awesome';
	...
	config.toolbar =
			[
			  ['Source','-','Maximize'],
				...
				['Link','Unlink','Image','Flash','Table','HorizontalRule','SpecialChar','FontFormat','FontName','CreateDiv','mobview','Indent','Outdent','BidiRtl','BidiLtr','Anchor','ImageMaps','doksoft_font_awesome']
