...
$config['LicenseName'] = 'Moshe Baroz';
$config['LicenseKey'] = 'DSH5-6SFG-CGF6-62PF-HCVD-QPJ6-EVWJ';
...
// TODO: Ask Moshe about that trick...
require_once($_SERVER['DOCUMENT_ROOT']."/config.inc.php");

//$baseUrl = 'https://s3.amazonaws.com/[bucketname]/[baseDir from below]';
$baseUrl = 'http://d3jy1qiodf2240.cloudfront.net';
// $baseUrl = 'http://s3.amazonaws.com/';
// $baseUrl = 'http://s3-eu-west-1.amazonaws.com/cdn.exiteme.com/';
...
// TODO: config for every user, change eldad.exitetogo.com...

$baseDir = "/exitetogo/". $SITE['S3_FOLDER'] ."/userfiles/";
$baseGalDir = "/exitetogo/". $SITE['S3_FOLDER'] ."/gallery/";

// $baseDir = "/exitetogo/". "eldad.exitetogo.com" ."/userfiles/";
...
$config['AmazonS3'] = Array(
    'AccessKey' => 'AKIAJTHBQC5L6NPUEWFQ',
    'SecretKey' => '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',
...
//7z,aiff,asf,avi,bmp,csv,doc,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,zip,vcf,ppt,pptx,pps,ppsx,pps,rar,docx


$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . $baseDir . "images/",
...
// $config['ResourceType'][] = Array(
// 		'name' => 'GalleryImages',
// 		'url' => $baseUrl . $baseGalDir,
// 		'directory' => $baseGalDir ,
// 		'maxSize' => 0,
// 		'allowedExtensions' => '',
// 		'deniedExtensions' => '');
