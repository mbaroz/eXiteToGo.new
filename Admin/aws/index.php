...
//Rename image name. 
$actual_image_name = "exitetogo/main.exitetogo.com/gallery/".time().".".$ext;
$actual_image_tumb_name = "exitetogo/main.exitetogo.com/gallery/tumbs/".time().".".$ext;
if($s3->putObjectFile($tmp, $bucket, $actual_image_name, S3::ACL_PUBLIC_READ) )
{
    $s3->putObjectFile($tmp, $bucket, $actual_image_tumb_name, S3::ACL_PUBLIC_READ);
