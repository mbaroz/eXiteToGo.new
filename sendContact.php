...
if ($SITE_LANG[selected]=="en") {
	$CONTACT_LABELS=array("Full Name", "Phone Number", "Email","Message","Date");
	$CONTACT_ERR=array("Please enter a valid email address", "Phone number is not valid", "Please enter a valid full name");
	
}
else {
	$CONTACT_LABELS=array("שם מלא", "טלפון", "אימייל","הודעה","תאריך");
...
function sendContactFrm($sid) {
	...
	if ($recipient=="" OR $recipient=="info@mysite.co.il") $recipient="websites@exite.co.il";
