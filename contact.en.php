...
function sendContact(rs) {
	if (rs=="<?=session_id();?>") {
		...
		jQuery('#msgContact').html("Contact information sent. One of our representatives<br> will contact you soon.");
...
<form id="contact_form" name="contact_form" method="post" action="<?=$PHP_SELF;?>" onsubmit="return false">
	...
	<div align="<?=$SITE[opalign];?>">Full Name: <input name="fullname" id="fullname" type="text" class="contact_frm"></div>
	<div style="height:5px"></div>
	<div align="<?=$SITE[opalign];?>">Phone: <input name="phone" id="phone" type="text" class="contact_frm" dir="ltr"></div>
	<div style="height:5px"></div>
	<div align="<?=$SITE[opalign];?>">Email: <input name="email"  id="email" type="text" class="contact_frm" dir="ltr"></div>
	<div style="height:5px"></div>
	<div align="<?=$SITE[opalign];?>" style="padding-<?=$SITE[align];?>:25px;"><textarea class="contact_frm_txt"  rows="5" name="contact_details" id="contact_details" onfocus="clearTextArea(this);">Your message here</textarea></div>
	<div style="height:5px"></div>
	...
	<tr>
	<td width="166" align="<?=$SITE[opalign];?>" style="height:30px;"><input type="button" value="Clear" onclick="contact_form.reset()"  class="frm_button"></td>
	<td width="154" align="<?=$SITE[opalign];?>" style="height:30px;"><input type="button" value="Send" class="frm_button" onclick="sendContact_frm()"></td>
	</tr>
	</table>
</div>
