...
#contact_layer td{vertical-align:top}
.contact_frm {
	width:98%;
	padding:2px;
...
<table cellspacing="2" border="0" cellpadding="0">
    <tr>
        <td><?=$CONTACT_LABELS[0];?>: <br><input name="fullname" id="fullname" type="text" class="contact_frm" autocomplete="off"></td>
    </tr>
    <tr>
        <td><?=$CONTACT_LABELS[1];?>: <br><input name="phne" id="phne" type="text" class="contact_frm" dir="ltr" autocomplete="off"></td>
    </tr>
    <tr>
        <td><?=$CONTACT_LABELS[2];?>: <br><input name="eml" id="eml" type="text" class="contact_frm" dir="ltr" autocomplete="off"></td>
    </tr>
    </tr>
    <tr>
	<td align="left" valign="middle">
        <div style="height:5px"></div>
	<input type="submit" value="<?=$CONTACT_LABELS[5];?>" class="frm_button">
	</td>
    </tr>
    </tr>
</table>
