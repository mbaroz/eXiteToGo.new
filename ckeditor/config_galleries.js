...
CKEDITOR.editorConfig = function( config )
{
	...
	config.toolbar =
			[
			  	['Source','Maximize','PasteText','PasteWord','Bold','Italic','Underline','Strike','FontSize','TextColor','BGColor','Link','Unlink','Image','Flash','HorizontalRule','Table','NumberedList','BulletedList','JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock','RemoveFormat','CreateDiv','mobview'],
			  	['Indent','Outdent','BidiRtl','BidiLtr','Anchor','ImageMaps','oembed','Iframe','Aviary','doksoft_font_awesome']
				]
	config.keystrokes =
			[
