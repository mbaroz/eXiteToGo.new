...
CKEDITOR.editorConfig = function( config )
{
	...
	config.toolbar=
			[
			  	['Source','Maximize','Bold','Italic','Underline','Strike','TextColor','BGColor'],
				['NumberedList','BulletedList','JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock','FontSize','Iframe'],
				['Image','Flash','HorizontalRule','Link','Unlink','RemoveFormat','PasteText','CreateDiv','BidiRtl','BidiLtr']
				]
	config.keystrokes =
			[
